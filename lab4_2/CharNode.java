 ...
 *
 * @see <A HREF="../../../../edu/colorado/nodes/CharNode.java"> Java Source Code
 *      for this class
...
public class CharNode {
	 ...
	 * @param initialLink
	 *            a reference to the node after this new node--this reference
	 ...
	 * 
	 * @param source
	 *            the head of a linked list that will be copied (which may be an
	 ...
	 *            empty list in where source is null)
	 * @return The method has made a copy of the linked list starting at source.
	 *         The return value is an array where the [0] element is a head
	 *         reference for the copy and the [1] element is a tail reference
	 *         for the copy.
	 * @exception OutOfMemoryError
	 *                Indicates that there is insufficient memory for the new
	 *                list.
	 ...
	 * 
	 * @param head
	 *            the head reference for a linked list (which may be an empty
	 ...
	 * 
	 * @param start
	 *            /end references to two nodes of a linked list
	 * @param copyHead
	 *            /copyTail the method sets these to refer to the head and tail
	 ...
	 *         is an array where the [0] component is a head reference for the
	 *         copy and the [1] component is a tail reference for the copy.
	 * @exception IllegalArgumentException
	 *                Indicates that start and end are not references to nodes
	 *                on the same list.
	 ...
	 *         the specified target. If there is no such node, the null
	 ...
	 * @exception NullPointerException
	 *                Indicates that this was the tail node of the list, so
	 *                there is nothing after it to remove.
	 **/
	...
	/**
	 * Convert a linked list of characters into a String
	 * 
	 * @return content of the linked list
	 */
	...
	public static void main(String[] args) {
		CharNode first = new CharNode('a', null);
		first.addNodeAtEnd('b');
		first.addNodeAtEnd('c');
		first.addNodeAtEnd('d');
		first.addNodeAtEnd('e');
