...
/******************************************************************************
 * An ArrayBag is a generic collection of references to objects. The same object
 * may appear multiple times in a bag.
 *
 ...
 *
 * @see <A HREF="../../../../edu/colorado/collections/ArrayBag.java"> Java
 *      Source Code for this class
 *      (www.cs.colorado.edu/~main/edu/colorado/collections/ArrayBag.java) </A>
 *
...
public class ArrayBag<E> implements Cloneable {
	 ...
	 **/
	@SuppressWarnings("unchecked")
	public ArrayBag<E> clone() { // Clone an ArrayBag object.
		ArrayBag<E> answer;
	...
	public boolean remove(E target) {
		...
		if (target == null) { // Find the first occurrence of the null reference
								// in the bag.
			index = 0;
			while ((index < manyItems) && (data[index] != null))
				index++;
		} else { // Find the first occurrence of the target in the bag.
			index = 0;
	...
	public static <E> ArrayBag<E> union(ArrayBag<E> b1, ArrayBag<E> b2) {
		...
		// Integer.MAX_VALUE, there will be an arithmetic overflow and
		// the bag will fail.
		ArrayBag<E> answer = new ArrayBag<E>(b1.getCapacity()
				+ b2.getCapacity());
