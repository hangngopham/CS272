...
public class LinkedQueue<E> implements Cloneable {
	 ...
	 *         the return value must be type cast to an <CODE>LinkedQueue</CODE>
	 *         before it can be used.
	 * @exception OutOfMemoryError
	 *                Indicates insufficient memory for creating the clone.
	 **/
	@SuppressWarnings("unchecked")
	public LinkedQueue<E> clone() { // Clone a LinkedQueue<E>.
	...
	public E remove() {
		...
		if (manyNodes == 0)
			// NoSuchElementException is from java.util and its constructor has
			// no argument.
	...
	/**
	 * Accessor method to return the item from the front of the queue without
